...
interface UseCenterListState {
  ...
  selectedCenterUuid: string | null; // Add selectedCenterUuid
  setSelectedCenterUuid: (uuid: string) => void; // Add setSelectedCenterUuid
  fetchCenterList: () => Promise<void>;
}

const useCenterList = create<UseCenterListState>((set) => ({
  centerList: [],
  selectedCenterUuid: null, // Initialize selectedCenterUuid
  setSelectedCenterUuid: (uuid) => set({ selectedCenterUuid: uuid }), // Define setSelectedCenterUuid
...
async function fetchCenterListDataFromApi(
  ...
  try {
    ...
    // Extract center data from response
